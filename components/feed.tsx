      ...
      <div className="w-full p-3 space-y-3 border rounded-lg shadow-md">
        <header className="flex justify-between">
          <div className="flex items-center space-x-2">
            ...
            />
            <h1 className="font-bold cursor-pointer">{author}</h1>
          </div>
          <svg
        ...
        <div className="relative w-full bg-slate-600 h-96">
          {mediaType === "Video" ? (
            <iframe src={media} allow="fullscreen" className="w-full h-full" />
          ) : (
            <Image
        ...
        <article>
          <div className="space-x-2">
            ...
            <div className="inline-block text-sm text-gray-900">{title}</div>
          </div>
          <div>{content}</div>
        </article>
