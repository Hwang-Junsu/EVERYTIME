      ...
      {isOpen ? (
        ...
        >
          <div
            ...
            role="presentation"
            className={cls(
              `p-5 min-w-[430px] lg:w-[800px] h-[600px] bg-white rounded-md overflow-hidden
`
            )}
          >
            <div className="flex flex-row space-x-2">
              <div className="w-full p-3 space-y-3 border rounded-lg shadow-md">
                <header className="flex justify-between">
                  <div className="flex items-center space-x-2">
                    <Image
                      src={data?.data?.post.user.image || BasicProfile}
                      width={48}
                      height={48}
                      alt="profileImage"
                ...
                <div className="flex w-full space-x-3">
                  <div onClick={onLikeClick}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill={cls("", data?.data?.isLike ? "red" : "none")}
                      viewBox="0 0 24 24"
                      strokeWidth="1.5"
                      stroke="currentColor"
                ...
                <div className="space-x-2 text-blue-400">
                  <Hashtags hashtags={data?.data?.post?.hashtags} />
                </div>
              ...
              <div className="hidden lg:block w-full  border rounded-lg shadow-md p-3">
                <header className="font-bold text-lg mb-2">댓글</header>
                    ...
                    >
                      <div className="flex space-x-2 items-center">
                        <div className="relative w-8 h-8 overflow-hidden rounded-full">
                          <Image layout="fill" src={comment.user.image} />
                        </div>
                      ...
                      <div className="text-[10px]">{comment.createdAt}</div>
                    </div>
                  ))}
                </div>
              </div>
